(function () {
    ...
    LightsController.$inject = ['$rootScope', '$interval', 'I2CRequestService', '$mdDialog'];

    function LightsController($rootScope, $interval, I2CRequestService, $mdDialog) {
        console.log('Entra en el controlador de iluminacion');
        var vm = this;
        vm.switch = [];
        vm.error = false;
        vm.reloadTime = 2000;
